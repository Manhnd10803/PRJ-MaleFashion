                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $active }}" data-toggle="tab" href="#tabs-{{ $i }}" role="tab">
                                    <div class="product__thumb__pic set-bg" data-setbg="{{ asset('storage/images/products/'.$image->srcImage) }}">
                                    </div>
                                </a>
                            </li>
                            @php
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-lg-8">
                        <div class="product__details__text">
                            ...
                            <h3>${{ $product->priceSale }} <span>${{ $product->price }}</span></h3>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('storage/images/products/'.$relatedProduct->srcImage) }}">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="{{ route('detailProduct', $relatedProduct->id) }}"><img src="{{ asset('storage/img/icon/search.png') }}" alt=""></a></li>
                            </ul>
                        </div>
                        <div class="product__item__text">
                            ...
                            <h5>${{ $relatedProduct->priceSale }} <del>${{ $relatedProduct->price }}</del></h5>
