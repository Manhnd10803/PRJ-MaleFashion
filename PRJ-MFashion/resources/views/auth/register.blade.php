                    ...
                    <div class="signup-form">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="fullname" id="name" placeholder="Your Name" value="{{ old('fullname') }}"/>
                            </div>
                            @error('fullname')
                            <p class="text-danger" style="margin-top:-20px;">{{ $message }}</p>
                            @enderror
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="name" placeholder="Your Address" value="{{ old('address') }}"/>
                            </div>
                            @error('address')
                            <p class="text-danger" style="margin-top:-20px;">{{ $message }}</p>
                            @enderror
