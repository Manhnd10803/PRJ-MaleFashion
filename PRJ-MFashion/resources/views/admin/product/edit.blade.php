                        ...
                        <form action="{{ route('product.update', $product->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-6">
                                    ...
                                    <input type="text" name="priceSale" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $product->priceSale }}">
                                    @error('priceSale')
                                    <div id="emailHelp" class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 col-4">
                                    ...
                                    <select name="category" id="" class="form-select" >
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}" @selected($product->idCategory == $category->id)>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-3 col-4">
                                    ...
                                    <select name="brand" id="" class="form-select" >
                                        ...
                                        <option value="{{ $brand->id }}" @selected($product->idBrand == $brand->id)>{{ $brand->name }}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="mb-3">
                                ...
                                @foreach ($product->images as $image)
                                    <img src="{{ asset('storage/images/products/'.$image->srcImage) }}" alt="" width="90" class="m-2">
                                @endforeach
                                @error('images')
                                    <div id="emailHelp" class="text-danger">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="row">
                                <div class="mb-3 col-2">
                                    ...
                                    <input type="number" name="sizeS" class="form-control" min="0" value="{{ $product->size->S }}">
                                </div>
                                <div class="mb-3 col-2">
                                    <label for="exampleInputEmail1" class="form-label">M</label>
                                    <input type="number" name="sizeM" class="form-control" min="0" value="{{ $product->size->M }}">
                                </div>
                                <div class="mb-3 col-2">
                                    <label for="exampleInputEmail1" class="form-label">L</label>
                                    <input type="number" name="sizeL" class="form-control" min="0" value="{{ $product->size->L }}">
                                </div>
                                <div class="mb-3 col-2">
                                    <label for="exampleInputEmail1" class="form-label">XL</label>
                                    <input type="number" name="sizeXL" class="form-control" min="0" value="{{ $product->size->XL }}">
                                </div>
                                <div class="mb-3 col-2">
                                    <label for="exampleInputEmail1" class="form-label">2XL</label>
                                    <input type="number" name="size2XL" class="form-control" min="0" value="{{ $product->size->XXL }}">
                                </div>
                                <div class="mb-3 col-2">
                                    <label for="exampleInputEmail1" class="form-label">3XL</label>
                                    <input type="number" name="size3XL" class="form-control" min="0" value="{{ $product->size->XXXL }}">
                                </div>
                            </div>
                            <div class="mb-3">
