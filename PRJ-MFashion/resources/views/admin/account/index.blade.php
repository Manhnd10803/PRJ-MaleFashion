        ...
        <div class="row">
            <div class="card w-100">
                <div class="card-body p-4">
                    ...
                    @can('addAccount')
                    <a href="{{ route('account.create') }}"><button type="submit" class="btn btn-success m-1">Add</button></a>
                    @endcan
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border-bottom-0" style="display: flex;">
                                    ...
                                    @can('updateAccount')
                                    <a href="{{ route('account.edit', $account->id) }}"><button type="submit" class="btn btn-info m-1">Update</button></a>
                                    @endcan
                                    @can('deleteAccount')
                                    ...
                                    @endcan
                                    @else
                                    <a href="{{ route('admin.account.unblock', $account->id) }}"><button type="submit" class="btn btn-primary m-1">Unblock</button></a>
                                    @endif
                                </td>
                            </tr> 
                            @php
